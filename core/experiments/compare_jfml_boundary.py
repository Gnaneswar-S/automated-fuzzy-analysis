...
JFML_FILE = HERE / "jfml_boundary_sweep.csv"

# Same predeclared criterion used in Step 57.
TOLERANCE = 1e-5
...
def load_jfml_results():
    ...
    data_lines = [
        ...
        for line in lines
        if line.strip()
        and not line.startswith("JFML_BOUNDARY_SWEEP")
...
def main():
    ...
    print("=== STEP 58: BOUNDARY / TRANSITION VALIDATION ===")
    ...
    if mismatches:
        ...
        print("RESULT")
        print("------")
        print("ALL 49 BOUNDARY OUTPUTS AGREE WITHIN THE PREDECLARED TOLERANCE.")
